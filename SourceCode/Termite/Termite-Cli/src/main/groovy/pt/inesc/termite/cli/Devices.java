...
public class Devices {
    ...
    private static int _DeviceId = 1; // counter that gets incremented every time a device is created
	...
	public void updateDevice(String name, String ctlrRealIp, int ctlrRealPort,
						  String appRealIp, int appRealPort, String appVirtIp, int appVirtPort) {
